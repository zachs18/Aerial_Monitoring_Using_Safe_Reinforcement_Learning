...
def Q_Learning(Pr_des, eps_unc, N_EPISODES, SHOW_EVERY, LEARN_RATE, DISCOUNT, EPS_DECAY, epsilon, i_s, pa, energy_pa, pa2ts, pa_s, pa_t, act_num, possible_acts, possible_next_states,  pick_up, delivery):
...
if __name__ == '__main__':
	...
	N_EPISODES = 5000       # of episodes
	SHOW_EVERY = 500        # Print out the info at every ... episode
	LEARN_RATE = 0.1
	DISCOUNT   = 0.95
	EPS_DECAY  = 1 #0.9995 #0.9993
	epsilon    = 0.1 
	eps_unc    = 0.07 # Uncertainity in actions
	Pr_des     = 0.90
	...
	if thr_fun < Pr_des:
		...
		opt_pol = Q_Learning(Pr_des, eps_unc, N_EPISODES, SHOW_EVERY, LEARN_RATE, DISCOUNT, EPS_DECAY, epsilon, i_s, pa, energy_pa, pa2ts, pa_s, pa_t, act_num, possible_acts, possible_next_states, pick_up, delivery)
