'''
.. module:: Safe RL
	Simulatenous Update as in paper but tracking the q as well
...
def Q_Learning(Pr_des, eps_unc, N_EPISODES, SHOW_EVERY, LEARN_RATE, DISCOUNT, EPS_DECAY, epsilon, i_s, pa, energy_pa, pa2ts, pa_s, pa_t, act_num, possible_acts, possible_next_states,  pick_up, delivery,  pick_ups, deliveries):
...
if __name__ == '__main__':
	...
	#delivery_state.append([(2,14,0)])                                         # print(pick_up_state)
	...
	if thr_fun < Pr_des:
		...
		opt_pol = Q_Learning(Pr_des, eps_unc, N_EPISODES, SHOW_EVERY, LEARN_RATE, DISCOUNT, EPS_DECAY, epsilon, i_s, pa, energy_pa, pa2ts, pa_s, pa_t, act_num, possible_acts, possible_next_states, pick_up, delivery,  pick_ups, deliveries)
