...
if __name__ == '__main__':
	...
	ep_len = 30 # Episode length
	m = 8       # of rows
	n = 8       # of columns  8
	h = 1       # height set to 1 for 2D case
	init_states    = [(7,0,0)]                                         # Specify initial states and obstacles (row,column,altitude/height)
	...
	pick_up_state  = [(5,7,0)]                                         # Specify pickup state
	delivery_state = [(2,7,0)]                                         # Specify delivery state
