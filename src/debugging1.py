...
if __name__ == '__main__':
	...
	custom_task = '[H^1 r1]^[0, 2] * [H^0 Base1]^[0,2]' # 
	##### System Inputs for Data Prep. #####
	ep_len = 5 # Episode length
	m = 2       # of rows
	n = 2       # of columns  8
	...
	[i_s, pa, pa_s, pa_t, pa2ts, energy_pa, rewards_pa, pick_up, delivery, pa_g_nodes] = prep_for_learning(ep_len, m, n, h, init_states, obstacles, pick_up_state[0], delivery_state[0], rewards, rew_val, custom_flag, custom_task)
