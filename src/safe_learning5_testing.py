...
if __name__ == '__main__':
	...
	ep_len = 31 # Episode length
	m = 7       # of rows
	n = 7       # of columns  8
	h = 1       # height set to 1 for 2D case
	init_states    = [(6,0,0)]                                         # Specify initial states and obstacles (row,column,altitude/height)
	obstacles = [(3,4,0), (3,3,0),  (2,4,0),  (2,3,0)]    # Indexed from (0,0,0) which is the upper left corner at ground height
	pick_up_state = []
	delivery_state = []
	...
	rewards   = [(4,0,0), (4,1,0), (5,0,0), (5,1,0)] # Rewarded states
	...
	epsilon    = 0.1 
	eps_unc    = 0.08 # Uncertainity in actions
	Pr_des     = 0.95
